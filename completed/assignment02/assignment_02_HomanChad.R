...
voter_turnout_df1 <- readxl::read_excel('data/G04ResultsDetail2004-11-02.xls',
...
db <- DBI::dbConnect(RSQLite::SQLite(), "data/tidynomicon/example.db")
...
## x <- DBI::dbReadTable(db, 'Site')
## x
tables <- lapply(table_names, DBI::dbReadTable, conn=db)
tables
