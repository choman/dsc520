...
`r round(topmovie_ave_ave, digits=2)` minutes (`r round(topmovie_ave_ave / 60, digits=1)` hours) per film beats the `r secondplace_ave_count` movie `r secondplace_ave` with 
