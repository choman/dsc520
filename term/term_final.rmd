...
per film. Beat the `r secondplace_vote_count` movie `r secondplace_vote` with a 
...
#### Top 10 Movie Collections (by runtime average)
...
(`r round(secondplace_ave_ave / 60,digits=1)` hours) per film by `r beat_ave_min`
minute(s). 
